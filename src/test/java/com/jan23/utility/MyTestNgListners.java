...
import com.steps.StepDefinationForSaleforceLogin;
...
public class MyTestNgListners implements ITestListener
{
	...
	public void onTestSuccess(ITestResult result) {
		...
		driver=StepDefinationForSaleforceLogin.getDriver();
		String path = StepDefinationForSaleforceLogin.getScreenshots(driver);
